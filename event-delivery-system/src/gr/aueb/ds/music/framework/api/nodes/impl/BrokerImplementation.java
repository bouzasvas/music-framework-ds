package gr.aueb.ds.music.framework.api.nodes.impl;
...
public class BrokerImplementation extends NodeAbstractImplementation implements Broker {
     ...
     *
     * @param artistName {@link gr.aueb.ds.music.framework.api.model.dto.ArtistName} The Requested Artist from Consumer
     ...
     *
     * @param removedPublisher {@link gr.aueb.ds.music.framework.api.nodes.api.Publisher} The publisher that disconnected from Network
     */
